...
const TokenDetialsPage2 = () => {
  ...
  const lastCharAddress = () => {
    ...
    var tokenAddress = currentTokenState.tokenAddress;
  ...
  const getCurrentTokenData = async () => {
    ...
    if (currentTokenData.success == true) {
      ...
      console.log("CheckDataTOkenDetail", currentTokenData.data);
      ...
      // console.log("CheckLocalDate", currentTokenData.unLockDateUnix);
  ...
  const [newFormateLockDate, setNewFormateLockDate] = useState("");
  ...
  useEffect(() => {
    if (currentTokenState) {
      ...
      let newLockDate = new Date(`${currentTokenState.Lock_Date}`);
      // newFormatedDate = newDate.toDateString();

      setNewFormateDate(newFormatedDate.toDateString());
      setNewFormateLockDate(newLockDate.toDateString());
    }
  }, [currentTokenState]);
  ...
  //       // var unLockedDate = new Date(Number(getunLockUnixTimeStamp) * 1000);
  //       //
  //     } else {
  //       var newDate = Number(unLockDate);
  ...
  useEffect(() => {
    const countDownFun = () => {
      ...
      // console.log("unLockDate007786", unLockDate);
  ...
  }, [getunLockUnixTimeStamp, currentTokenState, getCurrentDate]);
                    ...
                    {isSmallScreen ? (
                      ...
                      <>
                        ...
                        >
                          <Typography>Token Address</Typography>
                          <Typography>
                            {currentTokenState.tokenAddress}
                          </Typography>
                        </Box>
                      </>
                    )}
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        ...
                        <Typography>
                          {currentTokenState.total_Locked_Amount}{" "}
                          {currentTokenState.tokenSymbol}
                        </Typography>
                      </Box>
                      <Box
                        sx={{
...
export default TokenDetialsPage2;
